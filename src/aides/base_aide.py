...
class BaseAide(ABC):
    ...
    # Additional normalized thresholds used throughout intervention logic
    TASK_QUALITY_SUCCESS_THRESHOLD = 0.8
    INDEPENDENCE_LEVEL_LOW_THRESHOLD = 0.3
    INDEPENDENCE_LEVEL_BUILDING_THRESHOLD = 0.6

    BURNOUT_RISK_HIGH_THRESHOLD = 0.7
    BURNOUT_RISK_CRITICAL_THRESHOLD = 0.9

    STRESS_LEVEL_CRITICAL_THRESHOLD = 0.85
    STRESS_LEVEL_CRISIS_THRESHOLD = 0.95
